...
Procedure Test_GetSuccessfullRedirectAbsoluteAddress() Export
	...
	AssertEquals(Response.StatusCode, 200);
	AssertEquals(Result["url"], "http://httpbin.org/get");
...
Procedure Test_RedirectWithURLDefining() Export
	...
	AssertEquals(Response.StatusCode, 200);
	AssertEquals(Response.URL, "https://httpbin.org:443/anything");
...
Procedure Test_RetryBasedOnHeaderRetryAfterDuration() Export
	...
	ToRetryForStatusesCodes.Add(HTTPConnector.HTTPStatusCodes().ServiceUnavailable_503);
